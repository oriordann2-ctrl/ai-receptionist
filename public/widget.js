(function () {
  ...
  style.textContent = [
    ...
    "#sprimal-choices{padding:2px 0 6px;display:flex;flex-direction:column;gap:7px;align-self:stretch;max-width:92%;}",
    ".sprimal-choice{background:#fff;border:1.5px solid #111827;border-radius:20px;padding:9px 16px;font-size:13px;font-family:" + FONT + ";cursor:pointer;color:#111827;font-weight:500;transition:background .12s,color .12s;white-space:normal;line-height:1.4;letter-spacing:-0.01em;text-align:left;width:100%;box-sizing:border-box;}",
