  ...
  function showWorkflowStep(step) {
    ...
    if (socialChoices.length) {
      ...
      socialChoices.forEach(function (ch) {
        ...
        a.style.cssText = 'width:48px;height:48px;border-radius:50%;background:' + pd.color + ';display:flex;align-items:center;justify-content:center;text-decoration:none;flex-shrink:0;transition:opacity 0.15s;box-shadow:0 2px 6px rgba(0,0,0,0.15);';
