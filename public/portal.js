...
(function() {
  ...
  function renderSettings(d) {
    ...
    body.innerHTML = ''
      ...
      // Social Media + Club Photos — not shown for tennis clubs
      + (d.business_type !== 'tennis_club' ? (
    ...
    if (d.business_type !== 'tennis_club' && d.train_staff_enabled) loadStaff();
  }
  ...
  window.saveSocialHandles = function() {
    ...
    var tiktok       = ((document.getElementById("tiktokHandle") || {}).value || "").trim().replace(/^@/, "");
    ...
    var yelp         = ((document.getElementById("yelpUrl") || {}).value || "").trim();
